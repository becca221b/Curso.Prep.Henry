...
// ---------------------------------------------------------------------------//
  ...
  class Persona {
    ...
    /*detalle(nombre,apellido,edad,domicilio){
      return personaNueva= new Persona(this.nombre=nombre,this.apellido=apellido,this.edad=edad,this.domicilio=domicilio)
    }*/
  }
...
function crearInstanciaPersona(nombre, apellido, edad, dir) {
  ...
  return personaNueva= new Persona(nombre,apellido,edad,dir);
}
